...
alias permissions="docker run --rm -v /$PWD/api://var/www -w //var/www alpine chmod 777 storage/logs storage/temp storage/app"
alias permissions-all="docker run --rm -v /$PWD/api://var/www -w //var/www alpine chmod 777 ./"
